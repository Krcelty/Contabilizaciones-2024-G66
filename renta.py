...
nombre_salida = os.path.join(carpeta_salida, 'renta4 manager compra dolares.xlsx')
...
df_filtrado = df_origen[
    (df_origen.iloc[:, 3] == 'RENTA 4 CORREDORES DE BOLSA') &  # Columna D: "MBI CORREDORES DE BOLSA"
    (df_origen.iloc[:, 5] == 'BANCO SANTANDER USD') &  # Columna F: "BANCO BICE USD"
...
if df_filtrado.shape[0] == 0:
    ...
    codigo_cuenta_contableh = '110323'
    codigo_cuenta_contabled = '110322'
